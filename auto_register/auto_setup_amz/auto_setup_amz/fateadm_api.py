# coding=utf-8
from hashlib import md5 as md5m
...
def HttpRequest(url, body_data, img_data=""):
    ...
    rsp_data = post(url, post_data, files=files, headers=header)
